      ...
      <div className="group inline-flex">
        ...
        <label
          ...
          className={cn(
            ...
            "peer-disabled:cursor-not-allowed peer-disabled:bg-gray-100 peer-disabled:hover:border-gray-300 peer-disabled:dark:bg-gray-700 peer-disabled:hover:dark:border-gray-500",
            className
          )}
        >
          {children}
